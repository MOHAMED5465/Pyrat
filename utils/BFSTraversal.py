...
class BFSTraversal (Traversal):
    ...
    """
        This class extends the Traversal class to perform a breadth-first traversal.
        It explores the maze by visiting the neighbors of the current cell in increasing order of distance.
        It is guaranteed to find the shortest path to the cheese if it exists.
    """
    ...
    def get_from_structure ( self:      Self,
        ...
        # Extract the element from the beginning of the list
